...
export const metadata: Metadata = {
  title: "Mvpblocks - Build Your Next Product",
  description: "Join thousands of businesses using Mvpblocks to create exceptional digital products with powerful features.",
  keywords: "SaaS, MVP, Product Building",
  openGraph: {
    title: "Mvpblocks - Build Your Next Product",
    description: "Join thousands of businesses using Mvpblocks to create exceptional digital products with powerful features.",
    siteName: "Mvpblocks"
